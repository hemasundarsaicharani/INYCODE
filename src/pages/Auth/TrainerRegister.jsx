...
import { GraduationCap, Mail, Lock, Eye, EyeOff, ArrowLeft, ChevronRight, UserPlus, RefreshCw, User } from "lucide-react";
...
function TrainerRegister() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_BASE_URL || "http://localhost:5000"}/api/trainers/register`, {
        method: "POST",
        headers: {
          ...
          >
            <div className="auth-card-info">
                ...
                <div className="auth-info-content">
                    ...
                    >
                        <UserPlus size={64} className="gradient-text mb-4" style={{ margin: '0 auto 1.5rem', color: '#818cf8' }} />
                    </motion.div>
                    <h1>Create an <span className="gradient-text">Impact</span></h1>
                    <p>Share your knowledge and shape the future of tech education.</p>
                </div>
            </div>
            ...
            <div className="auth-card-content">
                ...
                <div className="auth-card-footer">
                    <p>Existing trainer? <span onClick={() => navigate("/trainer-login")} style={{ color: '#818cf8' }}>Portal Login</span></p>
                </div>
            </div>
          </motion.div>
        </div>
