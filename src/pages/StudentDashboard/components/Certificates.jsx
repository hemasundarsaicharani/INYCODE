...
const Certificates = () => {
    const certificates = [
        { course: "Full Stack Web Development", date: "Jan 2026", id: "CERT-IFC-2026-001", image: "https://via.placeholder.com/600x400/10b981/ffffff?text=Full+Stack+Mastery" },
        { course: "Modern UI/UX Design Masterclass", date: "Feb 2026", id: "CERT-IFC-2026-042", image: "https://via.placeholder.com/600x400/38bdf8/ffffff?text=UI/UX+Design" }
    ];
                        ...
                        <div className="cert-body">
                            ...
                            <div className="cert-footer-actions">
                               ...
                               <div className="cert-secondary-actions">
                                  <button className="social-share-btn glass" title="Share on LinkedIn">Li</button>
                                  <button className="social-share-btn glass" title="Add to Portfolio">P</button>
                               </div>
                            </div>
                        </div>
                    </motion.div>
